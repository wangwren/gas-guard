...
public class MonitorPointDao {
    ...
    public Page<MonitorPoint> selectPage(MonitorPointDto monitorPoint, Integer curr, Integer pageSize) {
        ...
        wrapper.eq(StrUtil.isNotBlank(monitorPoint.getAddress()), "address", monitorPoint.getAddress());
        ...
        wrapper.eq(StrUtil.isNotBlank(monitorPoint.getGasType()), "user_type", monitorPoint.getGasType());
